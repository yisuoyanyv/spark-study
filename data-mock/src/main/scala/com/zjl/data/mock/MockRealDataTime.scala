package com.zjl.data.mock

import java.util.Properties

import com.zjl.data.mock.bean.CityInfo
import com.zjl.data.mock.util.{RandomNumberUtil, RandomOptions}
import org.apache.kafka.clients.producer.{KafkaProducer, ProducerRecord}

import scala.collection.mutable.ArrayBuffer

object MockRealDataTime {

  /**
   * 数据格式
   * timestamp area city userid adis
  ...
  def mockRealTimeData():ArrayBuffer[String]={
    ...
    (1 to 50).foreach{
      i=>{
        ...
        val userid=RandomNumberUtil.randomInt(100,105)
        val adid=RandomNumberUtil.randomInt(1,5)
